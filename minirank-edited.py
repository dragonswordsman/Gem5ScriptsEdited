...
configs = os.path.expanduser("~/Research/gem5-extensions-2/configs")
addToPath(configs)
...
options.instructions = 100000000
...
# memory
mem_type = "DDR4_2400_16x4_raim5" # "DDR4_2400_8x8_raim5" #"DDR4_2400_8x8"
mem_channels = 1
mem_ranks = 2
mem_device_size = "1GB"
...
stats_file = options.binary + "_" + str(options.binary) + "_TRR.txt"
...
will run " + str(options.instructions) + "instructions on " + str(options.num_cpus) + " cpus.\n\
...
outdir = os.path.expanduser("~/Research/Gem5Output/2020/"+ options.binary)
...
stderr_file = "simerr_" + "_" + options.binary 
